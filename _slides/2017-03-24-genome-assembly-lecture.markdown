...
![bridges and graph]({{site.url}}/_slides/slide-data/genome-assembly/7-bridges-konigsberg.png)
...
![eulerian paths](https://www3.cs.stonybrook.edu/~skiena/combinatorica/animations/anim/euler.gif)
...
![assembly strategies]({{site.url}}/_slides/slide-data/genome-assembly/assembly-strategies.gif)
...
* example FASTQC report [found here]({{site.url}}/_slides/slide-data/genome-assembly/QC/multiqc_report.html)
